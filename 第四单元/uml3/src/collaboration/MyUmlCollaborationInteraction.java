...
public class MyUmlCollaborationInteraction implements UmlCollaborationInteraction {
    ...
    public MyUmlCollaborationInteraction(UmlElement... elements) {
        ...
        for (UmlElement e : elements) {
            ...
            if (e.getElementType() == ElementType.UML_INTERACTION) {
                ...
                collaborationId = e.getParentId();// UML_COLLABORATION may be not exist
                ...
                if (e.getParentId().equals(collaborationId)) {
    ...
    public boolean checkLifeline() {
        for (MyUmlLifeline umlLifeline : lifelines.values()) {
            if (umlLifeline.getUmlLifeline().getRepresent() == null) {
                return false;
            } else if (!attributes.containsKey(umlLifeline.getUmlLifeline().getRepresent())) {
                return false;
            }
        }
        return true;
