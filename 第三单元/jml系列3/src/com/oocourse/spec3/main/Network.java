...
public interface Network {
    ...
    /*@ public normal_behavior
      ...
      @         \old(getMessage(id).getPersogetSocialValue()) + \old(getMessage(id)).getSocialValue();
      @ ensures (\old(getMessage(id)) instanceof Redn1().getSocialValue()) + \old(getMessage(id)).getSocialValue() &&
      @         \old(getMessage(id)).getPerson2().getSocialValue() ==
      @         \old(getMessage(id).getPerson2().EnvelopeMessage) ==>
