...
public class MyUmlStateChartInteraction implements UmlStateChartInteraction {
    ...
    public MyUmlStateChartInteraction(UmlElement... elements) {
        ...
        for (UmlElement e : elements1) {
            ...
            MyUmlState myUmlState = new MyUmlState(e);
        ...
        while (!queue.isEmpty()) {
            ...
            if (state.hasToState()) {
                ...
                for (MyUmlState e : toStates) {
                    if (states.containsKey(e.getUmlState().getName())) {
    ...
    public boolean checkInitialState() {
        for (MyUmlStateMachine umlStateMachine : stateMachines.values()) {
            if (!umlStateMachine.checkInitialState()) {
                return false;
            }
        }
        return true;
